...
export const animeConstants = [
    {
        ...
        imagePath: require("/public/anime-images/hyouka.jpg")// Example image path for Hyouka
    },
    {
        ...
        imagePath:require("/public/anime-images/attack.jpg")// Example image path for Attack on Titan
    },
    {
        ...
        imagePath:require("/public/anime-images/5sec.jpg")// Example image path for 5 Centimeters Per Second
    },
  
    {
        ...
        imagePath:require("/public/anime-images/honey.jpg") // Example image path for Honey and Clover
    },
...

    {
        ...
        imagePath:require("/public/anime-images/death.jpg")
      },
...
export const MovieConstants = [
    {
        ...
        imagePath:require("/public/anime-images/Dark-knight.jpg")
...

    {
        ...
        imagePath:require("/public/anime-images/inception.jpg")
...

    {
        ...
        imagePath:require("/public/anime-images/the-shawshank-redemption.jpg")
...
export const MangaConstants = [
    {
        ...
        imagePath:require("/public/anime-images/classroom-of-the-elite.jpg")
...

    {
        ...
        imagePath:require("/public/anime-images/vagabond.jpg")
